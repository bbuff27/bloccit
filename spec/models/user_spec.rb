...
RSpec.describe User, type: :model do
  ...
  describe "invalid user" do
    ...
    it "should be an invalid email due to a blank email" do
  ...
  describe "#favorite_for(post)" do
    ...
    it "returns nil if a user has not favorited a post" do 
  ...
  describe ".avatar_url" do
    ...
    it "returns the proper Gravatar avatar for a known email entity" do
