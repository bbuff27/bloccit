...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it "assignes my_sponsored_post to @sponsored_post" do
      get :show, params: { topic_id: my_topic.id, id: my_sponsored_post.id }
  ...
  describe "PUT update" do
    it "updates sponsored_post with expected attributes" do
      ...
      put :update, params: { topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: rand(1..100)} }
